    ...
    func session(_ session: WCSession, activationDidCompleteWith activationState: WCSessionActivationState, error: (any Error)?) {
        ...
        DispatchQueue.main.async {
            ...
            if let currency = applicationContext["currency"] as? Int {
                ...
                UserDefaults(suiteName: AppGroupManager.suiteName)?
                    .set(currentCurrency + currency, forKey: "currency")
            }
            ...
            if let showReward = applicationContext["showReward"] as? Bool {
                ...
                UserDefaults(suiteName: AppGroupManager.suiteName)?
                    .set(showReward, forKey: "showReward")
            }
        }
    }
